# repo-cleanup-governance Specification

## Purpose
Define the cleanup governance rules for AI-NPC repository cleanup work so destructive actions, prompt ownership changes, public test seam changes, validation harness changes, and engine-source boundaries remain explicit, reviewable, and proportionately verified.
